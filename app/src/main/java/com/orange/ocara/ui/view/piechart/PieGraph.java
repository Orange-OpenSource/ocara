...
public class PieGraph extends View implements HoloGraphAnimate {
    ...
    public PieGraph(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.orange.ocara.R.styleable.PieGraph, 0, 0);
        mInnerCircleRatio = a.getInt(com.orange.ocara.R.styleable.PieGraph_pieInnerCircleRatio, 0);
        mPadding = a.getDimensionPixelSize(com.orange.ocara.R.styleable.PieGraph_pieSlicePadding, 0);
    }
    ...
    public void animateToGoalValues() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR1) {
            Timber.e("Animation not supported on api level 12 and below. Returning without animating.");
            return;
        }
        if (mValueAnimator != null)
            mValueAnimator.cancel();
