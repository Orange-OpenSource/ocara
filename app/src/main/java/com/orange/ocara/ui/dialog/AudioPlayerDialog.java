...
@EFragment(R.layout.dialog_audio_player)
public class AudioPlayerDialog extends BaseDialogFragment implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    @ViewById(R.id.audio_player_progress)
    ...
    private static class MessageHandler extends Handler {
        ...
        private final WeakReference<AudioPlayerDialog> mAudioPlayerDialogWeakReference;

        MessageHandler(AudioPlayerDialog mediaPlayer) {
            super();
            mAudioPlayerDialogWeakReference = new WeakReference<>(mediaPlayer);
        }

        @Override
        public void handleMessage(Message msg) {
            AudioPlayerDialog audioPlayerDialog = mAudioPlayerDialogWeakReference.get();
            if (audioPlayerDialog != null) {
                MediaPlayer mediaPlayer = audioPlayerDialog.mediaPlayer;
                if (mediaPlayer == null) {
                    return;
                }
                ...
                if (msg.what == SHOW_PROGRESS) {
                    pos = audioPlayerDialog.updateProgress();
                    if (!audioPlayerDialog.draggingProgressBar && mediaPlayer.isPlaying()) {
