...
@EBean
public class RulesetsSpinnerAdapter extends BaseAdapter {

    @RootContext
    Context mContext;
    private List<RulesetEntity> mRulsetDetails;

    public void setData(List<RulesetEntity> rulsetDetails) {
        mRulsetDetails = rulsetDetails;
    ...
    @Override
    public int getCount() {
        return mRulsetDetails != null ? mRulsetDetails.size() : 0;
    }

    @Override
    public RulesetEntity getItem(final int position) {
        return mRulsetDetails != null ? mRulsetDetails.get(position) : null;
    }
