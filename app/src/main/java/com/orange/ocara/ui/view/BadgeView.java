...
public class BadgeView extends AppCompatTextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#EF6C00"); //Color.ORANGE;
    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;
    private static final int FROM_ALPHA = 0;
    private static final int TO_ALPHA = 1;
    private static final int FROM_ALPHA_FADE_OUT = 1;
    private static final int TO_ALPHA_FADE_OUT = 0;
    private static final int DURATION_MILLIS_TRANSITION = 200;
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        fadeIn = new AlphaAnimation(FROM_ALPHA, TO_ALPHA);
        fadeIn.setInterpolator(new DecelerateInterpolator());
        fadeIn.setDuration(DURATION_MILLIS_TRANSITION);

        fadeOut = new AlphaAnimation(FROM_ALPHA_FADE_OUT, TO_ALPHA_FADE_OUT);
        fadeOut.setInterpolator(new AccelerateInterpolator());
        fadeOut.setDuration(DURATION_MILLIS_TRANSITION);
