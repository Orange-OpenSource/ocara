...
public interface RulesetService {
    ...
    /**
     * retrieves a holder for a HTTP request and its response, which format is a {@link List} of {@link RulesetModel}s.
     *
     * @return a {@link Call} for a {@link List} of {@link RulesetModel}s
     */
    @GET("ws/rulesetlist")
    Call<List<RulesetLightWs>> getRuleSetList();
