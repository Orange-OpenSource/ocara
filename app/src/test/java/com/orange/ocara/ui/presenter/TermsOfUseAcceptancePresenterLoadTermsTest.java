...
/**
 * @see TermsOfUseAcceptancePresenter#loadTerms()
 */
public class TermsOfUseAcceptancePresenterLoadTermsTest {
    ...
    private void prepareSubject(UseCase<LoadTermsOfUseRequest, LoadTermsOfUseResponse> task) {
        ...
        subject = new TermsOfUseAcceptancePresenter(view, mock(UseCase.class), mock(UseCase.class), task);
    }
}