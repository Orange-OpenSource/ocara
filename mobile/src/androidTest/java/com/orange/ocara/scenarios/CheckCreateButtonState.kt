...
import com.orange.ocara.mobile.scenarios.ViewAssertions.ButtonIsDisabledOrEnabledAssertion
...
class CheckCreateButtonState : ParentUITest(){
    ...
    fun checkCreateButtonState() {
        ...
        onView(withId(R.id.create_audit_button)).check(ButtonIsDisabledOrEnabledAssertion(false))
                ...
                allOf(withId(R.id.auditorEmailET),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                7)))
        appCompatEditText4.perform(scrollTo(), replaceText("email@email"), closeSoftKeyboard())
        ...
        val createButton = onView(
                allOf(withId(R.id.create_audit_button), withText("CREATE NEW AUDIT"),
                        ...
                        isDisplayed()))
        createButton.check(ButtonIsDisabledOrEnabledAssertion(true))
    }
