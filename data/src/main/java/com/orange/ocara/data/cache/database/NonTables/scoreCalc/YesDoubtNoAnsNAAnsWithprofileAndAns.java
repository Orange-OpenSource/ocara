...
public class YesDoubtNoAnsNAAnsWithprofileAndAns extends AnswerCount{
...
//    QuestionAnswerModel.Answer answer;
    ...
    public YesDoubtNoAnsNAAnsWithprofileAndAns(int count, String profileName, String profileRef, Answer answer) {
        super(count, answer);
//        this.count = count;
