...
public class LoadAuditEquipments {
    AuditEquipmentRepository repository;
    @Inject
    public LoadAuditEquipments(AuditEquipmentRepository repository){
        this.repository=repository;
    }
    public Single<List<AuditEquipmentModel>> execute(Long auditId){
        return repository.loadAuditEquipments(auditId);
    }
}
