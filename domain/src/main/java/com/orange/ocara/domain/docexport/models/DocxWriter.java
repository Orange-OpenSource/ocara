...
public class DocxWriter {
    ...
    DocxWriter(File workingDirectory, File exportFile, DocxExporter exporter) {
    ...
    public static DocxWriterBuilder builder() {
        return new DocxWriterBuilder();
    }


    public static class DocxWriterBuilder {
        ...
        public DocxWriterBuilder workingDirectory(File workingDirectory) {
            this.workingDirectory = workingDirectory;
            return DocxWriterBuilder.this;
        }

        public DocxWriterBuilder exportFile(File exportFile) {
            this.exportFile = exportFile;
            return DocxWriterBuilder.this;
        }

        public DocxWriterBuilder exporter(DocxExporter exporter) {
            this.exporter = exporter;
            return DocxWriterBuilder.this;
        }

        public DocxWriter build() {
            return new DocxWriter(this.workingDirectory, this.exportFile, this.exporter);
        }

        @Override
        public String toString() {
            return "DocxWriter.DocxWriterBuilder(workingDirectory=" + this.workingDirectory + ", exportFile=" + this.exportFile + ", exporter=" + this.exporter + ")";
        }
    }
