...
public class GetRuleSetDataForEquipmentId {
    AuditEquipmentRepository repository;

    @Inject
    public GetRuleSetDataForEquipmentId(AuditEquipmentRepository repository) {
        this.repository = repository;
    }
    public Single<RulesetRefAndVersion> execute(int auditEqId){
        return repository.getRuleSetAndVersion(auditEqId);
    }
}
