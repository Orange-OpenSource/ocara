...
public class GetAuditEquipmentById {
    AuditEquipmentRepository repository;
    @Inject
    public GetAuditEquipmentById(AuditEquipmentRepository repository){
        this.repository = repository;
    }
    public Single<AuditEquipmentWithNumberOfCommentAndOrderModel> execute(int auditEquipmentId){
        return repository.getAuditEquipmentById(auditEquipmentId);
    }
}
