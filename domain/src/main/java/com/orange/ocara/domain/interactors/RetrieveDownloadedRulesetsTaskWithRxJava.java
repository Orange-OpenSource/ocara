...
public class RetrieveDownloadedRulesetsTaskWithRxJava {
    private final RulesetRepository rulesetRepository;

    @Inject
    public RetrieveDownloadedRulesetsTaskWithRxJava(RulesetRepository rulesetRepository) {
        this.rulesetRepository = rulesetRepository;
    }
    public Single<List<RulesetModel>> execute(){
        return rulesetRepository.findDownloadedWithRxJava();
    }
}
