...
public class CheckDefaultRulesetIsInserted {
    RulesetRepository repository;

    @Inject
    public CheckDefaultRulesetIsInserted(RulesetRepository repository) {
        this.repository = repository;
    }

    public Single<Integer> execute(){
        return repository.checkIfDemoRulesetIsInserted();
    }
}
