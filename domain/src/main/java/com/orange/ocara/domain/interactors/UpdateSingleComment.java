...
public class UpdateSingleComment {
    CommentRepository commentRepository;

    @Inject
    public UpdateSingleComment(CommentRepository commentRepository) {
        this.commentRepository = commentRepository;
    }
    public Completable execute (CommentModel commentModel){
        return commentRepository.updateSingleComment(commentModel);
    }
}
